...
keybinds = {
	...
	-- Hotbar Row #3
	{
	    ...
	    'CTRL + -',    -- Hotbar Row #3 Col #11
	    'CTRL + =',    -- Hotbar Row #3 Col #12
	},
	-- Hotbar Row #4
	{
	    ...
	    'Shift + 5',    -- Hotbar Row #4 Col #5
	    'Shift + 6',    -- Hotbar Row #4 Col #6
	    'Shift + 7',    -- Hotbar Row #4 Col #7
	    'Shift + 8',    -- Hotbar Row #4 Col #8
	    'Shift + 9',    -- Hotbar Row #4 Col #9
	    'Shift + 0',    -- Hotbar Row #4 Col #10
	...
	-- Hotbar Row #5
	{
	    ...
	    'Shift + u',    -- Hotbar Row #5 Col #7
	    'Shift + i',    -- Hotbar Row #5 Col #8
	    'Shift + o',    -- Hotbar Row #5 Col #9
	    'Shift + p',    -- Hotbar Row #5 Col #10
	    'Shift + [',    -- Hotbar Row #5 Col #11
	    'Shift + ]',    -- Hotbar Row #5 Col #12
	},
	-- Hotbar Row #6
	{
	    'Alt + q',    -- Hotbar Row #6 Col #1
	    'Alt + w',    -- Hotbar Row #6 Col #2
	    'Alt + e',    -- Hotbar Row #6 Col #3
	    'Alt + r',    -- Hotbar Row #6 Col #4
	    'Alt + t',    -- Hotbar Row #6 Col #5
	    'Alt + y',    -- Hotbar Row #6 Col #6
	    'Alt + u',    -- Hotbar Row #6 Col #7
	    'Alt + i',    -- Hotbar Row #6 Col #8
	    'Alt + o',    -- Hotbar Row #6 Col #9
	    'Alt + p',    -- Hotbar Row #6 Col #10
	    'Alt + [',    -- Hotbar Row #6 Col #11
	    'Alt + ]',    -- Hotbar Row #6 Col #12
	}
}
