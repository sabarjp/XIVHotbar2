...
-- Load and initialize the include file.
 xivhotbar_keybinds_job['Base'] = {
  ...
  -- Hotbar #5
	{'battle 5 1', 'macro', 'input /equip ammo "Pet Food Alpha";wait 1;input /ja Reward <pet>', '', 'Alpha'},
	{'battle 5 2', 'macro', 'input /equip ammo "Pet Food Beta";wait 1;input /ja Reward <pet>', '', 'Beta'},
	{'battle 5 3', 'macro', 'input /equip ammo "Pet Food Gamma";wait 1;input /ja Reward <pet>', '', 'Gamma'},
	{'battle 5 4', 'macro', 'input /equip ammo "Pet Food Delta";wait 1;input /ja Reward <pet>', '', 'Delta'},
	{'battle 5 5', 'macro', 'input /equip ammo "Pet Food Epsilon";wait 1;input /ja Reward <pet>', '', 'Epsilon'},
	{'battle 5 6', 'macro', 'input /equip ammo "Pet Food Zeta";wait 1;input /ja Reward <pet>', '', 'Zeta'},
	{'battle 5 7', 'macro', 'input /equip ammo "Pet Food Eta";wait 1;input /ja Reward <pet>', '', 'Eta'},
	{'battle 5 8', 'macro', 'input /equip ammo "Pet Food Theta";wait 1;input /ja Reward <pet>', '', 'Theta'},

  -- Hotbar #6
	{'battle 6 1', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 2', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 3', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 4', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 5', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 6', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 7', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 8', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 9', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 10', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 11', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
	--{'battle 6 12', 'macro', 'input /equip ammo "Carrot Broth";wait 1;input /ja "Bestial Loyalty" <me>', '', 'Rabbit'},
